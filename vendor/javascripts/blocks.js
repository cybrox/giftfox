 ...
 * // â†’ [{ 'name': 'pebbles', 'blocked': true, 'employer': 'na' }]
 */
...
/**
ï»¿ * Creates an array of numbers (positive and/or negative) progressing from start up to but not including end.
ï»¿ * If start is less than stop a zero-length range is created unless a negative step is specified.
ï»¿ *
ï»¿ * @memberof ArrayExpression
ï»¿ * @param   {number} [start=0] - The start of the range
ï»¿ * @param   {number} end - The end of the range
ï»¿ * @param   {number} [step=1] - The value to increment or decrement by
ï»¿ * @returns {Array} - Returns a new range array
ï»¿ *
ï»¿ * @example {javascript}
ï»¿ * blocks.range(4);
ï»¿ * // â†’ [0, 1, 2, 3]
ï»¿ *
ï»¿ * blocks.range(1, 5);
ï»¿ * // â†’ [1, 2, 3, 4]
ï»¿ *
ï»¿ * blocks.range(0, 20, 5);
ï»¿ * // â†’ [0, 5, 10, 15]
ï»¿ *
ï»¿ * blocks.range(0, -4, -1);
ï»¿ * // â†’ [0, -1, -2, -3]
ï»¿ *
ï»¿ * blocks.range(1, 4, 0);
ï»¿ * // â†’ [1, 1, 1]
ï»¿ *
ï»¿ * blocks.range(0);
ï»¿ * // â†’ []
